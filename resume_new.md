...
*Senior Software Engineer* | 2014 – 2021
*   Engineered low-latency, multithreaded 3D-graphical navigation software tailored for resource-constrained embedded devices.
*   Executed the full software development lifecycle (SDLC)—including requirements analysis, effort estimation, feature implementation, and rigorous testing—within an Agile framework.
*   Streamlined development pipelines by integrating and maintaining complex 3rd party and open-source code libraries.
*   Partnered with distributed Software Quality Assurance (SQA) and remote engineering teams via CI/CD pipelines to ensure seamless, high-quality feature deployments.

**Ultra Electronics – 3Phoenix** – Wake Forest, NC
*Senior Software Engineer* | 2012 – 2014
*   Developed innovative, real-time 3D display solutions for situational awareness, enabling the processing of high-resolution, 360-degree panoramic imagery and motion video.
*   Led the GUI development and test control systems for torpedo test software deployed by the Department of Defense (DoD).
...
*   Authored technical design documentation and delivered project presentations directly to military and government stakeholders. *(Maintained U.S. Security Clearance)*

**Textile/Clothing Technology Corporation** – Cary, NC
*Software Engineer* | 2005 – 2008
*   Designed and implemented computer vision algorithms to process and visualize 3D point cloud data generated from 2D images on full-body scanner hardware.
*   Maintained, optimized, and provided end-to-end software support for the proprietary 3D body scanning ecosystem.

**Stony Brook University (Center for Visual Computing)** – Stony Brook, NY
*Research Assistant* | 2002 – 2005
*   Researched and developed robust algorithms for 3D object modeling, geometric processing, and computer animation, producing functional software prototypes to validate theoretical concepts.

**EDUCATION & TRAINING**
*   **M.S. in Computer Science** – Stony Brook University, Stony Brook, NY (2003)
*   **B.S. in Computer Science & Applied Mathematics** – Siena College, Loudonville, NY (2001)
*   *Training:* AWS Cloud Practitioner (2022) | Harvard CS50: Web Programming with Python and JS (2020)

**PUBLICATIONS & AWARDS**
*   **ARA Technical Achievement Award** (2010)
*   *Topology-based Surface Mapping with Exact Feature Alignment* – IEEE International Visualization Conference (2005)
